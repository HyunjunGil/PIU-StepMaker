...
BI_BPM_TEXTBOX = FILE_PLAY_BUTTON + 1
BI_BM_TEXTBOX = FILE_PLAY_BUTTON + 2
BI_BS_TEXTBOX = FILE_PLAY_BUTTON + 3
BI_DL_TEXBOX = FILE_PLAY_BUTTON + 4
BI_DL_UNIT_BUTTON = FILE_PLAY_BUTTON + 5
BI_MS_TEXTBOX = FILE_PLAY_BUTTON + 6
BI_BT_TEXTBOX = FILE_PLAY_BUTTON + 7
BI_SP_TEXTBOX = FILE_PLAY_BUTTON + 8
BI_APPLY_BUTTON = FILE_PLAY_BUTTON + 9
